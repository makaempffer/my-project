...
export default function Cards() {
    return (
        <div className='p-5 md:p-14 md:flex container md:space-x-10 w-screen mx-auto space-y-5 md:space-y-0'>
            <div className='w-fit md:w-80 h-1/3 rounded-lg md-h-1/2 md:opacity-50 hover:opacity-100 duration-500 shadow-md hover:shadow-md hover:scale-105'>
                ...
                <div className='px-5'>
                    <a href='#house'>
                        <h1 className='font-roboto font-bold text-2xl uppercase text-gray-700 underline underline-offset-4 decoration-white decoration-2'>
                        House Name,
                        </h1>
                    </a> 
                </div>
